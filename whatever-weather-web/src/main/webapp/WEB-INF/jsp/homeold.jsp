					...
					<div class="container">
						<div class="row">
							...
							<div class="span10">
								...
								<p>
									<a class="btn btn-primary btn-lg" href="weather.x?zip=44418">Current
										Weather&raquo;</a> <a class="btn btn-primary btn-lg"
										href="history.x?zip=44418">Weather History&raquo;</a>
								</p>
							</div>
						</div>
					</div>
				...
				<div class="row placeholders">
					<div class="col-xs-6 col-sm-3 placeholder">
						...
						<span class="text-muted">
							...
							<form>
								<ul>
									<li><label for="lat">Latitude</label> , <label for="lon">longitude</label>
										<input name="lat" id="lat" type="text"> , <input
										name="lon" id="lon" type="text"> or
